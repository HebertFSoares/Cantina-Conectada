...
public class TelaRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogar.setMaximumSize(new java.awt.Dimension(95, 35));
        btnLogar.setMinimumSize(new java.awt.Dimension(95, 35));
        btnLogar.setPreferredSize(new java.awt.Dimension(95, 35));
        btnLogar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLogarActionPerformed(evt);
            }
        });
        getContentPane().add(btnLogar, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 270, 80, -1));
